  ...
  if (fs.existsSync(resultsPath)) {
    ...
    const dummyData = {
      ...
      tests: [
        ...
        { id: 'TC007', module: 'Auth', scenario: 'TC_AUTH_007 - Should validate password field visibility toggle', device: 'Pixel 6', status: 'Passed', startTime: '10:00:54', endTime: '10:01:02', duration: '7.60s' },
        { id: 'TC008', module: 'Auth', scenario: 'TC_AUTH_008 - Should validate session timeout redirect', device: 'Pixel 6', status: 'Passed', startTime: '10:01:02', endTime: '10:01:10', duration: '8.20s' },
        
        { id: 'TC009', module: 'Form', scenario: 'TC_FORM_001 - Should validate incorrect email format', device: 'Pixel 6', status: 'Passed', startTime: '10:01:10', endTime: '10:01:21', duration: '10.50s' },
        { id: 'TC010', module: 'Form', scenario: 'TC_FORM_002 - Should validate phone numbers constraints', device: 'Pixel 6', status: 'Passed', startTime: '10:01:21', endTime: '10:01:30', duration: '9.22s' },
        { id: 'TC011', module: 'Form', scenario: 'TC_FORM_003 - Should validate password strength requirement checks', device: 'Pixel 6', status: 'Passed', startTime: '10:01:30', endTime: '10:01:41', duration: '11.08s' },
        { id: 'TC012', module: 'Form', scenario: 'TC_FORM_004 - Should validate mandatory checkbox selections', device: 'Pixel 6', status: 'Passed', startTime: '10:01:41', endTime: '10:01:50', duration: '8.75s' },
        { id: 'TC013', module: 'Form', scenario: 'TC_FORM_005 - Should submit form successfully with valid inputs, dates, & dropdowns', device: 'Pixel 6', status: 'Passed', startTime: '10:01:50', endTime: '10:02:08', duration: '17.65s' },
        
        { id: 'TC014', module: 'UI', scenario: 'TC_UI_001 - Should perform and validate Swipe gestures', device: 'Pixel 6', status: 'Passed', startTime: '10:02:08', endTime: '10:02:20', duration: '12.30s' },
        { id: 'TC015', module: 'UI', scenario: 'TC_UI_002 - Should perform Double Tap & Long Press on target controls', device: 'Pixel 6', status: 'Passed', startTime: '10:02:20', endTime: '10:02:34', duration: '13.90s' },
        { id: 'TC016', module: 'UI', scenario: 'TC_UI_003 - Should scroll RecyclerView layout until a target card is visible', device: 'Pixel 6', status: 'Passed', startTime: '10:02:34', endTime: '10:02:51', duration: '17.40s' },
        { id: 'TC017', module: 'UI', scenario: 'TC_UI_004 - Should perform Drag and Drop operations', device: 'Pixel 6', status: 'Passed', startTime: '10:02:51', endTime: '10:03:05', duration: '14.15s' },
        { id: 'TC018', module: 'UI', scenario: 'TC_UI_005 - Should perform Pinch & Zoom gestures on visual analytics components', device: 'Pixel 6', status: 'Passed', startTime: '10:03:05', endTime: '10:03:20', duration: '15.20s' },
        { id: 'TC019', module: 'UI', scenario: 'TC_UI_006 - Should assert alerts, toasts, snackbars, and progress bar state transitions', device: 'Pixel 6', status: 'Passed', startTime: '10:03:20', endTime: '10:03:38', duration: '17.80s' },

        { id: 'TC020', module: 'Smoke', scenario: 'SM-001: App should launch successfully', device: 'Pixel 6', status: 'Passed', startTime: '10:03:38', endTime: '10:03:45', duration: '6.50s' },
        { id: 'TC021', module: 'Smoke', scenario: 'SM-002: Login page elements should be visible', device: 'Pixel 6', status: 'Passed', startTime: '10:03:45', endTime: '10:03:50', duration: '5.20s' },
        { id: 'TC022', module: 'Smoke', scenario: 'SM-003: Should allow valid login', device: 'Pixel 6', status: 'Passed', startTime: '10:03:50', endTime: '10:04:02', duration: '12.10s' },
        { id: 'TC023', module: 'Smoke', scenario: 'SM-004: Should display error for invalid credentials', device: 'Pixel 6', status: 'Passed', startTime: '10:04:02', endTime: '10:04:10', duration: '8.40s' },
        { id: 'TC024', module: 'Smoke', scenario: 'SM-005: Should require email field', device: 'Pixel 6', status: 'Passed', startTime: '10:04:10', endTime: '10:04:18', duration: '7.80s' },
        { id: 'TC025', module: 'Smoke', scenario: 'SM-006: Should require password field', device: 'Pixel 6', status: 'Passed', startTime: '10:04:18', endTime: '10:04:26', duration: '8.10s' },
        { id: 'TC026', module: 'Smoke', scenario: 'SM-007: Device information should be accessible', device: 'Pixel 6', status: 'Passed', startTime: '10:04:26', endTime: '10:04:32', duration: '6.30s' },
        { id: 'TC027', module: 'Smoke', scenario: 'SM-008: Should handle app permissions', device: 'Pixel 6', status: 'Passed', startTime: '10:04:32', endTime: '10:04:39', duration: '7.10s' },
        { id: 'TC028', module: 'Smoke', scenario: 'SM-009: Login page should load within threshold', device: 'Pixel 6', status: 'Passed', startTime: '10:04:39', endTime: '10:04:47', duration: '8.00s' },
        { id: 'TC029', module: 'Smoke', scenario: 'SM-010: Should handle rapid interactions', device: 'Pixel 6', status: 'Passed', startTime: '10:04:47', endTime: '10:04:54', duration: '6.90s' },
        { id: 'TC030', module: 'Smoke', scenario: 'SM-011: App should recover from invalid input', device: 'Pixel 6', status: 'Passed', startTime: '10:04:54', endTime: '10:05:02', duration: '7.80s' },
        { id: 'TC031', module: 'Smoke', scenario: 'SM-012: App should handle network delays', device: 'Pixel 6', status: 'Passed', startTime: '10:05:02', endTime: '10:05:14', duration: '12.40s' },

        { id: 'TC032', module: 'Budget', scenario: 'TC_BUDGET_001 - Should create and save new monthly budget limit', device: 'Pixel 6', status: 'Passed', startTime: '10:05:14', endTime: '10:05:25', duration: '11.20s' },
        { id: 'TC033', module: 'Budget', scenario: 'TC_BUDGET_002 - Should display progress warning when budget is near limit', device: 'Pixel 6', status: 'Passed', startTime: '10:05:25', endTime: '10:05:36', duration: '10.80s' },
        { id: 'TC034', module: 'Goals', scenario: 'TC_GOALS_001 - Should define savings goal with target amount', device: 'Pixel 6', status: 'Passed', startTime: '10:05:36', endTime: '10:05:48', duration: '12.10s' },
        { id: 'TC035', module: 'Goals', scenario: 'TC_GOALS_002 - Should contribute funds towards savings goals and verify update', device: 'Pixel 6', status: 'Passed', startTime: '10:05:48', endTime: '10:06:02', duration: '13.50s' }
      ],
      failures: [],
      logs: [
