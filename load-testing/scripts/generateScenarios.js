...
const scenarios = [
  ...
  { name: 'register', method: 'POST', path: '/api/auth/register', body: { id: 'new-user-12345', name: 'New User', email: 'new_user_12345@test.com', joinedAt: new Date().toISOString() }, validator: 'body.success === true' },
  ...
  { name: 'smartEntry', method: 'POST', path: '/api/transactions', body: { id: 'tx-smart-123', raw: 'Dinner INR 1500', title: 'Dinner', amount: 1500, category: 'Food', categoryIcon: '🍔', categoryColor: '#ef4444', date: new Date().toISOString(), dateLabel: 'Today', type: 'expense' }, validator: 'body.success === true' },
  ...
  { name: 'addExpense', method: 'POST', path: '/api/transactions', body: { id: 'tx-add-123', raw: 'Taxi INR 500', title: 'Taxi Ride', amount: 500, category: 'Transport', categoryIcon: '🚌', categoryColor: '#3b82f6', date: new Date().toISOString(), dateLabel: 'Today', type: 'expense' }, validator: 'body.success === true' },
  ...
  { name: 'incomeManagement', method: 'POST', path: '/api/transactions', body: { id: 'tx-inc-123', raw: 'Salary INR 80000', title: 'Salary', amount: 80000, category: 'Salary', categoryIcon: '💰', categoryColor: '#10b981', date: new Date().toISOString(), dateLabel: 'Today', type: 'income' }, validator: 'body.success === true' },
