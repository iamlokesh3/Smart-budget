...
export function parseEntry(text) {
  ...
  if (onMatch) {
    // e.g. "spent 300 on pizza" -> onMatch[1] = "spent", onMatch[2] = "pizza"
    // e.g. "dinner on pizza" -> category = pizza, title = dinner on pizza
    ...
    // e.g. "paid 1500 for books" -> forMatch[1] = "paid", forMatch[2] = "books"
    // e.g. "shoes for sports" -> category = sports, title = shoes for sports
    // e.g. "Bought shoes for ₹2500" (which became "bought shoes")
    // Wait, if it was "bought shoes for ₹2500", and the "for ₹2500" was stripped as amount,
    // the cleaned text is "bought shoes". No "for" matches anymore.
    ...
    // No preposition. Strip leading verbs.
